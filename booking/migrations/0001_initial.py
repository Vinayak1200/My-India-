# Generated by Django 4.0.10 on 2023-04-27 17:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nationality', models.IntegerField(choices=[(0, 'Indian'), (1, 'NRI')])),
                ('dateofvisit', models.DateField()),
                ('age', models.IntegerField()),
                ('numberadult', models.IntegerField(null=True)),
                ('country', models.CharField(max_length=100)),
                ('parking', models.IntegerField(choices=[(0, 'None'), (1, 'Car'), (2, 'Bike')])),
            ],
        ),
        migrations.CreateModel(
            name='Place',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PlaceID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='booking.place', unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
